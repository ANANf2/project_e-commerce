                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="register2.php" method="POST">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" name="address" id="inputAddress" type="address" placeholder="Address" />
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPhone" type="phone" placeholder="Phone" />
